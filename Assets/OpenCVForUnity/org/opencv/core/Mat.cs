 ...
 */
        ...
        public static Mat ones(int[] sizes, int type)
        {
            ...
            Mat retVal = new Mat(core_Mat_n_1ones__I_3II(sizes.Length, sizes, sizes.Length, type));
...
#if UNITY_5_3_OR_NEWER
            Mat retVal = new Mat(core_Mat_n_1reshape_11(nativeObj, cn, newshape.Length, newshape, newshape.Length));
...
#if UNITY_5_3_OR_NEWER
            int retVal = core_Mat_n_1size_1i__JI(nativeObj, i);
 ...
 */
        ...
        public Mat submat(Range[] ranges)
        {
            ...
            Mat retVal = new Mat(core_Mat_n_1submat_1ranges(nativeObj, rangesArray, rangesArray.Length));
 ...
 */
        ...
        public static Mat zeros(int[] sizes, int type)
        {
            ...
            Mat retVal = new Mat(core_Mat_n_1zeros__I_3II(sizes.Length, sizes, sizes.Length, type));
